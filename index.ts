...
let teacherName: string = "Mannal Rana";

// single quotes k sath
let countryName: string = 'pakistan';

// backticks k sath
let userName: string = `Areeba Bano`; 

let greet: string = "Sir Bilal";
// console.log(greet);
...
// console.log(fruits[5])
            ...
            //   index no  0    , 1    ,   2       , 3
let fruit: string[] = ["Mango","Cherry","Stawberry","Kiwi","Apple","Watermelon"];
...
let trafficSignal: "red"|"green"|"yellow" = "green";
...
let description: string = "This is a very long string";
...
let numbers: 20|50|60 = 20
console.log(numbers);

// 15. Create a union literals

let Rs: string|number = "Three Thousand";
Rs = 3000;
